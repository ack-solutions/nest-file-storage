...
const PACKAGE_PATH = path.join(__dirname, "../packages/nest-file-storage/package.json");
...
function updateVersion(versionType) {
  ...
  console.log(`✅ Updated @ackplus/nest-file-storage from ${oldVersion} to ${newVersion}\n`);
...
async function main() {
  try {
    ...
    if (success) {
      ...
      console.log(`📦 https://www.npmjs.com/package/@ackplus/nest-file-storage/v/${versionInfo.newVersion}`);
      console.log(`\n📥 Install with:`);
      console.log(`   npm install @ackplus/nest-file-storage@${versionInfo.newVersion}`);
      console.log(`   pnpm add @ackplus/nest-file-storage@${versionInfo.newVersion}\n`);
    }
